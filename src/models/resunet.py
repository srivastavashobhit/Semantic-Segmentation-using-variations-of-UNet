...
class ResUNet(tf.keras.Model):
    ...
    def call(self, inputs, training=False):
        ...
        resnet_skip_connection = tf.identity(x)
        ...
        x = ResUNet.skip_connection(x, skip_connection_input_4)
        ...
        x = ResUNet.skip_connection(x, skip_connection_input_3)
        ...
        x = ResUNet.skip_connection(x, skip_connection_input_2)
        ...
        x = ResUNet.skip_connection(x, skip_connection_input_1)
